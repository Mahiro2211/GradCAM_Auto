...
def parse_option():
    ...
    parser.add_argument('--batch-size', type=int,default=48, help="batch size for single GPU")
    ...
    parser.add_argument('--resume',default='crossformer-b.pth', help='resume from checkpoint')
